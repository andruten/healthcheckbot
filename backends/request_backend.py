...
from .entities import ServiceFetchResponse

logger = logging.getLogger(__name__)


class RequestBackend(BaseBackend):
    async def check(self, session) -> ServiceFetchResponse:
        headers = {
        ...
        try:
            ...
            return ServiceFetchResponse(service_is_healthy=False)
        else:
            ...
            return ServiceFetchResponse(
                service_is_healthy=not service_is_healthy,
